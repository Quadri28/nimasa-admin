...
const CooperativeSignIn = () => {
  ...
  const validationSchema = Yup.object({
    cooperativeId: Yup.string().required('Required'),
  ...
  const onSubmit = async (values) => {
    ...
    navigate("/admin-dashboard")
      ...
      toast(resp.data.message, {type:'error', autoClose:false, autoClose:5000})
      setTimeout(() => {
  ...
  return (
    ...
    <div className="cooperative-form-container">
      <div className="text-center">
        ...
        <img src={Union} alt="App Logo" className="img-fluid" width={20} /> 
        <strong style={{fontSize:'18px', marginLeft:'5px', }}>UCP Cooperative portal</strong>
        </div>
      ...
      {loading ?  (
       <div className="text-center mx-auto w-25">
        ...
        <div style={{ width: "100%" }} className="inputs-container">
          <label htmlFor="cooperativeId" className="mb-1">
            Cooperative ID <sup className="text-danger fw-bold">*</sup>
          </label>
          <br />
          <Field
            type="text"
            ...
            className="w-100"
          />
           <ErrorMessage name="cooperativeId" component={ErrorText}/>
        </div>
        <div style={{ width: "100%" }} className="inputs-container">
