...
import { FaTimesCircle, FaAngleRight, FaCheckCircle } from "react-icons/fa";
    ...
    >
      <div className="d-flex justify-content-between container pt-2">
        ...
        <div className="justify-self-end">
          ...
          <p>
            <Link to="/cooperative-signup" className="sign-link">
              Create your Cooperative portal
            </Link>
          </p>
        </div>
      </div>
      <div className="reset-password">
        <div style={{ marginInline: "auto" }}>
          <div className="text-center">
            ...
            />
            <strong
              style={{ fontSize: "18px", marginLeft: "5px", color: "#333" }}
            >
          ...
          >
            {({ values }) => (
              <Form>
                ...
                <div
                  className="bg-white px-2 pb-2  mx-auto row reset-password-container"
                  style={{ borderRadius: "0 0 20px  20px" }}
                >
                  {loading ? (
                    <div className="text-center mx-auto w-25">loading...</div>
                  ) : (
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <div className="d-flex justify-content-between my-2 flex-wrap">
                      <span style={{ fontSize: "10px", color: "#4d4d4d" }}>
                        Must include:
                      </span>
                      <div
                      ...
                      >
                        <span
                          ...
                          style={{
                            padding: "2px 8px",
                            backgroundColor: /[A-Z]/.test(values.newPassword)
                              ? "#D8EDE0"
                              : "#F6DADA",
                            borderRadius: "10px",
                            color: /[A-Z]/.test(values.newPassword)
                              ? "#0B5125"
                              : "#9A1B1B",
                          }}
                        >
                        ...
                        <span
                          ...
                          style={{
                            padding: "2px 5px",
                            backgroundColor: /\d/.test(values.newPassword)
                              ? "#D8EDE0"
                              : "#F6DADA",
                            borderRadius: "10px",
                            color: /\d/.test(values.newPassword)
                              ? "#0B5125"
                              : "#9A1B1B",
                          }}
                        >
                    ...
                    <div className="d-flex justify-content-between flex-wrap my-2">
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{
                            padding: "2px 5px",
                            backgroundColor: /\d/.test(values.confirmPassword)
                              ? "#D8EDE0"
                              : "#F6DADA",
                            borderRadius: "10px",
                            color: /\d/.test(values.newPassword)
