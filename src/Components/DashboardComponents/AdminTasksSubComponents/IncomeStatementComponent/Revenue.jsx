...
const Revenue = () => {
  const {targetRef, toPDF} = usePDF({filename: 'Revenue.pdf'}) 
    const data =[
        {
            name:'Maresk Hamzik',
            type:'Type one',
    ...
    const column=[
       ...
       {Header: 'Total Owed', accessor: 'totalOwed'}
    ]
  ...
  return (
    ...
    <div className='d-sm-flex justify-content-between align-items-center my-3'>
      <form className='my-2 search-anything'>
      ...
      <div className='d-flex gap-2 export-btn-container my-2 flex-wrap'>
        <CSVLink data={data} filename='Revenues.csv'>
