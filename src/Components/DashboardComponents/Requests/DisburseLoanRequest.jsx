...
const DisburseLoanRequest = () => {
  ...
  const getLoanFundingSources = () => {
    axios("RequestVerification/loan-funding-source-slim", {
      headers: {
  ...
  const getRepaymentTypes = () => {
    axios("Common/getloanrepayments", {
      headers: {
        Authorization: `Bearer ${credentials.token}`,
      },
  ...
  const getModels = () => {
    axios("LoanApplication/get-lending-model", {
      headers: {
        Authorization: `Bearer ${credentials.token}`,
      },
  ...
  const getGroups = () => {
    axios("LoanApplication/get-loan-group", {
      headers: {
        Authorization: `Bearer ${credentials.token}`,
      },
  ...
  const getProductDetails = () => {
    axios(
      `LoanApplication/loan-product-detail?loanProductCode=${detail?.loanProduct}`,
      {
        headers: {
          Authorization: `Bearer ${credentials.token}`,
        },
  ...
  const getDetail = () => {
    axios(
      `RequestVerification/get-loan-disbursement-detail?LoanApplicationNo=${id}`,
      {
        headers: {
          Authorization: `Bearer ${credentials.token}`,
        },
  ...
  const disburseLoan = (e) => {
    ...
    const payload = {
      ...
      gaurators: [detail.guarantors],
    };
    axios
      .post("RequestVerification/loan-application", payload, {
        headers: {
          Authorization: `Bearer ${credentials.token}`,
        },
      })
...
const futureDate = addMonths(detail?.firstPaymentDate, detail?.term -1);
  ...
  return (
    <form onSubmit={disburseLoan}>
      <div className="card rounded-4" style={{ border: "solid 1px #fafafa" }}>
        <div className="py-4 px-3">
          ...
          <div className="admin-task-forms mx-1">
            ...
            >
              ...
              <div className="mt-3">
                ...
                <div
                  className="d-flex justify-content-between align-items-center flex-wrap px-3 mb-2"
                  style={{ fontSize: "14px" }}
                >
                  <div className="d-flex gap-3 discourse">
                ...
                <div className="d-flex gap-3 discourse px-3">
                  ...
                  <span>
                    {product?.collateralvalue?.toLocaleString("en-US")}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="d-flex justify-content-between align-items-center px-3 flex-wrap">
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(detail?.accountInfo?.bookBalance)}
                  </p>
                </div>
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(detail?.accountInfo?.usableBalance)}
                  </p>
                </div>
              </div>
              ...
              <div className="d-flex justify-content-between align-items-center px-3 flex-wrap">
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(detail?.accountInfo?.effectiveBalance)}
                  </p>
                </div>
                <div className="d-flex gap-3 discourse">
          ...
          <div className="admin-task-forms mt-3">
            ...
            <div className="d-flex flex-column gap-1">
              ...
              <DatePicker
                selected={
                  detail?.postingDate ? new Date(detail?.postingDate) : null
                }
                disabled
                onChange={(date) =>
                  handleChange({
            ...
            <div className="d-flex flex-column gap-1">
              <label htmlFor="maturityDate">Maturity Date</label>
               <DatePicker
                selected={
                  // detail?.maturityDate ? new Date(detail?.maturityDate) : null
                  futureDate
                }
                disabled
                dateFormat="dd-MM-yyy"
            ...
            <div className="d-flex flex-column gap-1">
              ...
              <select
                ...
                name="lendingModel"
                onChange={handleChange}
                value={detail?.productOtherDetail?.lendingModel}
              >
                <option value="">Select</option>
                {models.map((model) => (
                  <option value={model.lendingCode} key={model.lendingCode}>
                    {model.lendingName}
                  </option>
                ))}
              </select>
            ...
            <div className="d-flex flex-column gap-1">
              ...
              <input
                type="text"
                name="chargeConcession"
                onChange={handleChange}
                value={detail?.chargeConcession}
              />
            </div>
            <div className="d-flex flex-column gap-1">
              ...
              <select
                ...
                onChange={handleChange}
                value={detail?.productOtherDetail?.calculationMethod}
              >
                <option value="">Select</option>
                {methods.map((method) => (
            ...
            <div className="d-flex flex-column gap-1">
              ...
              <input
                ...
                onChange={handleChange}
                value={detail?.productOtherDetail?.collateralDetail}
              />
            </div>
            <div className="d-flex flex-column gap-1">
              ...
              <select
                ...
                name="loanSource"
                onChange={handleChange}
                value={detail?.productOtherDetail?.loanSource}
              >
                <option value="">Select</option>
                {sources.map((type) => (
                  <option value={type.loanSourceId} key={type.loanSourceId}>
                    {type.loanSourceName}
                  </option>
                ))}
              </select>
        ...
        <div
          className="d-flex gap-3 mt-4 align-items-center justify-content-end p-3"
          style={{ backgroundColor: "#f2f2f2", borderRadius: "0 0 15px 15px" }}
        >
          <button className="btn-md rounded-5 px-3 border-0 py-2" type="reset">
            Reset
          </button>
          <button className="btn-md member border-0" type="submit">
            Submit
          </button>
        </div>
      </div>
