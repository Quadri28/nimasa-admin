...
const AccountReactivation = () => {
 ...
 const reactivateAccount =(acct)=>{
  axios(`MemberManagement/account-reactivation-account-number-text-changed?AccountNumber=${acct}`, {
    headers:{
      Authorization: `Bearer ${credentials.token}`
    }
  })
  ...
  const onSubmit = (values) => {
    ...
    axios
      .post("MemberManagement/account-reactivation", payload, {
        headers: {
          Authorization: `Bearer ${credentials.token}`,
        },
      })
 ...
 <Combobox
  ...
  onChange={(val) => {
    ...
    if (val && typeof val === "object") {
      ...
      reactivateAccount(val.accountNumber);
    }
  }}
/>
            </div>
          ...
          <div className="px-3 pt-2">
            <div className="d-flex flex-column gap-1 ">
              ...
              <Field
                name="narration"
                as="textarea"
                value={reactivateAccountNumbers.narration}
                style={{
                  outlineColor: "#69A4FC",
                  outlineWidth: ".2px",
                  border: "none",
              ...
              <div className="px-3 py-2 d-flex flex-column gap-1 gap-2">
                ...
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    ...
                    }).format(reactivateAccountNumbers?.bookBalance)}
                  </p>
                </div>
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(reactivateAccountNumbers?.effectiveBalance)}
                  </p>
                </div>
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(reactivateAccountNumbers?.usableBalance)}
                  </p>
                </div>
                <div className="d-flex gap-3 discourse">
                ...
                <div className="d-flex gap-3 discourse">
                  ...
                  <p>
                    {new Intl.NumberFormat("en-US", {
                      minimumFractionDigits: 2,
                    }).format(reactivateAccountNumbers?.totalCharge)}
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <button
              type="reset"
              className="border-0 px-4 rounded-4 btn-md"
