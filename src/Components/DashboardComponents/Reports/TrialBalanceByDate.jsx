...
//   // Grand totals across all report entries
...
//           <label htmlFor="startDate">As at Date:</label>
//           <input
//             type="date"
//             className="rounded-3 p-2  w-full"
//             style={{ border: 'solid 1px #ddd', outline: 'none', height: '2.5rem' }}
//             name={startDate}
...
//                 {openProductTypes.includes(report?.prodTypeName) &&
//                   Object.keys(groupedLoans).map((gl_ClassName) => (
//                     <React.Fragment key={gl_ClassName}>
//                       <tr onClick={() => toggleGLClass(gl_ClassName)}>
//                         <td colSpan="4" style={{
//                           fontSize: "12px",
//                           cursor: "pointer",
//                           padding: "5px 0",
...
//                           color: 'black'
//                         }}>
//                           {openGLClasses.includes(gl_ClassName) ? <FaAngleUp /> : <FaAngleDown />}{" "}
//                           {gl_ClassName}
//                         </td>
//                       </tr>

//                       {openGLClasses.includes(gl_ClassName) &&
//                         groupedLoans[gl_ClassName].map((loan) => (
//                           <tr key={loan.glNumber}>
//                             <td>{loan.acctNo}</td>
//                             <td>{loan.acctName}</td>
//                             <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(loan.debitAcct)}</td>
//                             <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(loan.creditAcct)}</td>
//                           </tr>
//                         ))}
//                     </React.Fragment>
//                   ))}
...
//                   <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(totalDebit)}</td>
//                   <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(totalCredit)}</td>
//                 </tr>
//               </tbody>
//             );
//           })}
...
//               <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(grandTotalDebit)}</td>
//               <td>{new Intl.NumberFormat('en-US', { minimumFractionDigits: 2 }).format(grandTotalCredit)}</td>
//             </tr>
//           </tfoot>
//         </table>
