     ...
     const fetchData = React.useCallback(({ pageSize, pageNumber }) => {
        ...
        setTimeout(() => {
          if (fetchId === fetchIdRef.current) {
            axios
              .get(
                `RequestApproved/approved-loan-requests?PageSize=${pageSize}&PageNumber=${pageNumber + 1}`,
                {
                  headers: {
      ...
      const column = [
         ...
         {Header:'Loan Number', accessor:'loanNo'},
