...
const ComprehensiveIncomeNote = ({ financialPositionNoteReports, startDate, endDate }) => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, `ComprehensiveIncome_${startDate}_to_${endDate}.xlsx`);
  };
  ...
  const exportToPDF = () => {
    ...
    doc.save(`ComprehensiveIncome_${startDate}_to_${endDate}.pdf`);
  };
...
export default ComprehensiveIncomeNote;
